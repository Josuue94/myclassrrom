    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>MyClassroom</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['escritorio']==1)
            {
              ...
              <a href="escritorio.php">
                <i class="fa fa-tasks"></i> <span>Tablero</span>
              </a>
            </li>';
            }
            ?>
            ...
            if ($_SESSION['almacen']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lArticulos"><a href="inicio.php"><i class="fa fa-circle-o"></i> Primero</a></li>
                <li id="lCategorias"><a href="categoria.php"><i class="fa fa-circle-o"></i> Segundo</a></li>
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Tercero</a></li>
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Cuarto</a></li>
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Quinto</a></li>
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Sexto</a></li>
                <li id="lVentas"><a href="venta.php"><i class="fa fa-circle-o"></i> Septimo</a></li>
                <li id="lClientes"><a href="cliente.php"><i class="fa fa-circle-o"></i> Octavo</a></li>
                <li id="lClientes"><a href="cliente.php"><i class="fa fa-circle-o"></i> Noveno</a></li>
              </ul>
            </li>';
            }
            ?>
